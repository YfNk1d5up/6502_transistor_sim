...
static Microcode microcode[] = {
    ...
    {
        .key = (0xF0 << 8) | (0x00), // Load PC = 0000 on ABL/ABH, Increment PC on ADL and ADH
        .value =
            RCL_BIT(RCL_RnotW) |
            RCL_BIT(RCL_LOAD_PCL_PCL) |
            RCL_BIT(RCL_EN_PCL_ADL) |
    ...
    {
        .key = (0xF0 << 8) | (0x01), // Read RAM at 0000 
        .value =
            RCL_BIT(RCL_RnotW) |
            RCL_BIT(RCL_EN_DL_DB)
    },
    {
        .key = (0xF0 << 8) | (0x02), // Load PC = 0001 on ABL/ABH, Increment PC on ADL and ADH
        .value =
            RCL_BIT(RCL_RnotW) |
            RCL_BIT(RCL_LOAD_PCL_PCL) |
            RCL_BIT(RCL_EN_PCL_ADL) |
    ...
    {
        .key = (0xF0 << 8) | (0x03), // Read RAM at 0001
        .value =
            RCL_BIT(RCL_RnotW) |
            RCL_BIT(RCL_EN_DL_DB)
    },
